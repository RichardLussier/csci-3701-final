...
Let's first extract Imholte's Electrical Demand data and the Explanatory Variables we hope to use into a new dataframe.

```{r}
# Create new dataframe of only Imholte's Electrical Demand data and explanatory variables

imholteData <- demandData[, c("Date", "Science_East_Wing", "Weekday", "Month", "preCOVID", "studentsOnBreak", "Dry_Bulb")]
...
ggplot(imholteData, aes(Weekday, Science_East_Wing)) +
  geom_boxplot()


# Create a model by Weekday
mod <- lm(Science_East_Wing ~ Weekday, data = imholteData)
...
imholteData <- imholteData %>%
  add_residuals(mod, var="Imholte_WDay_Resids")

ggplot(imholteData, aes(Date, Imholte_WDay_Resids)) + 
  geom_ref_line(h=0) + 
  geom_line()
```
...
mod <- lm(formula = Science_East_Wing ~ Month, data = imholteData)
...
ggplot(imholteData, aes(Month, Science_East_Wing)) +
  geom_boxplot() +
  geom_point(data = grid, colour = "red", size = 4)
...
ggplot(imholteData, aes(Date, Imholte_Month_Resids)) +
  geom_ref_line(h=0) +
  geom_line()
```
...
# Create a model by preCovid
mod <- lm(Science_East_Wing ~ preCOVID, data = imholteData)
...
ggplot(imholteData, aes(preCOVID, Science_East_Wing)) +
  geom_boxplot() +
  geom_point(data = grid, colour = "red", size = 4)
...
ggplot(imholteData, aes(Date, Imholte_preCovid_Resids)) + 
  geom_ref_line(h=0) + 
  geom_line()
...
# Create a model by studentsOnBreak
mod <- lm(Science_East_Wing ~ studentsOnBreak, data = imholteData)
...
ggplot(imholteData, aes(studentsOnBreak, Science_East_Wing)) +
  geom_boxplot() +
  geom_point(data = grid, colour = "red", size = 4)
...
ggplot(imholteData, aes(Date, Imholte_onBreak_Resids)) + 
  geom_ref_line(h=0) + 
  geom_line()
...
# Create a model by preCovid and onBreak
mod <- lm(Science_East_Wing ~ preCOVID + studentsOnBreak, data = imholteData)
...
ggplot(imholteData, aes(Date, Science_preCovidBreak_Resids)) + 
  geom_ref_line(h=0) + 
  geom_line()
...
mod <- lm(Science_East_Wing ~ preCOVID + Weekday, data = imholteData)
...
ggplot(imholteData, aes(Date, Science_preCovidWday_Resids)) + 
  geom_ref_line(h=0) + 
  geom_line()


# Create a model by onbreak and weekday
mod <- lm(Science_East_Wing ~ studentsOnBreak + Weekday, data = imholteData)
...
ggplot(imholteData, aes(Date, Science_onBreakWday_Resids)) + 
  geom_ref_line(h=0) + 
  geom_line()


# Create a model by preCovid and weekday and onBreak
mod <- lm(Science_East_Wing ~ preCOVID + Weekday + studentsOnBreak, data = imholteData)
...
ggplot(imholteData, aes(Date, Science_all_Resids)) + 
  geom_ref_line(h=0) + 
  geom_line()
